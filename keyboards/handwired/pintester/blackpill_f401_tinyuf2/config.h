...
// Exclude some pins by default:
//   - A9 - has an internal pull-down from the USB VBUS function;
//   - B2 - has an external pull-down resistor due to its BOOT1 function.
#define PINTESTER_DEFAULT_IGNORE_PINS A9, B2
