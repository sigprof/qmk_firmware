...
class TapDanceLayerMove : public TestFixture {};

TEST_F(TapDanceLayerMove, SingleTap) {
    TestDriver driver;
    InSequence s;
    auto       key_l_move    = KeymapKey{0, 1, 0, TD(TD_L_MOVE)};
    auto       key_normal    = KeymapKey{0, 2, 0, KC_A};
    auto       key_l_move_l1 = KeymapKey{1, 1, 0, KC_TRNS};
    auto       key_normal_l1 = KeymapKey{1, 2, 0, KC_B};

    set_keymap({key_l_move, key_normal, key_l_move_l1, key_normal_l1});
...
TEST_F(TapDanceLayerMove, SingleTapCustom) {
    TestDriver driver;
    InSequence s;
    auto       key_l_move    = KeymapKey{0, 1, 0, TD(TD_L_MOVE)};
...
TEST_F(TapDanceLayerMove, SingleTapFast) {
    TestDriver driver;
    InSequence s;
    auto       key_l_move    = KeymapKey{0, 1, 0, TD(TD_L_MOVE)};
    auto       key_normal    = KeymapKey{0, 2, 0, KC_A};
...
TEST_F(TapDanceLayerMove, SingleTapFastCustom) {
    TestDriver driver;
    InSequence s;
    auto       key_l_move    = KeymapKey{0, 1, 0, TD(TD_L_MOVE)};
    auto       key_normal    = KeymapKey{0, 2, 0, CUST_XY};
...
TEST_F(TapDanceLayerMove, SingleTapRolling) {
    TestDriver driver;
    InSequence s;
    auto       key_l_move    = KeymapKey{0, 1, 0, TD(TD_L_MOVE)};
    auto       key_normal    = KeymapKey{0, 2, 0, KC_A};
...
TEST_F(TapDanceLayerMove, SingleTapRollingCustom) {
    TestDriver driver;
    InSequence s;
    auto       key_l_move    = KeymapKey{0, 1, 0, TD(TD_L_MOVE)};
    auto       key_normal    = KeymapKey{0, 2, 0, CUST_XY};
...
TEST_F(TapDanceLayerMove, DoubleTap) {
    TestDriver driver;
    InSequence s;
    auto       key_l_move    = KeymapKey{0, 1, 0, TD(TD_L_MOVE)};
    auto       key_normal    = KeymapKey{0, 2, 0, KC_A};
    ...
    // Double tap does not send anything, but switches the layer immediately.
    tap_key(key_l_move);
    tap_key(key_l_move);
    EXPECT_NO_REPORT(driver);
...
TEST_F(TapDanceLayerMove, DoubleTapCustom) {
    TestDriver driver;
    InSequence s;
    auto       key_l_move    = KeymapKey{0, 1, 0, TD(TD_L_MOVE)};
    auto       key_normal    = KeymapKey{0, 2, 0, CUST_XY};
...
TEST_F(TapDanceLayerMove, DoubleTapFast) {
    TestDriver driver;
    InSequence s;
    auto       key_l_move    = KeymapKey{0, 1, 0, TD(TD_L_MOVE)};
    auto       key_normal    = KeymapKey{0, 2, 0, KC_A};
...
TEST_F(TapDanceLayerMove, DoubleTapFastCustom) {
    TestDriver driver;
    InSequence s;
    auto       key_l_move    = KeymapKey{0, 1, 0, TD(TD_L_MOVE)};
    auto       key_normal    = KeymapKey{0, 2, 0, CUST_XY};
...
TEST_F(TapDanceLayerMove, DoubleTapRolling) {
    TestDriver driver;
    InSequence s;
    auto       key_l_move    = KeymapKey{0, 1, 0, TD(TD_L_MOVE)};
    auto       key_normal    = KeymapKey{0, 2, 0, KC_A};
    ...
    // Tap-then-hold does not send anything, but switches the layer
    // immediately.
    tap_key(key_l_move);
    key_l_move.press();
    run_one_scan_loop();
...
TEST_F(TapDanceLayerMove, DoubleTapRollingCustom) {
    TestDriver driver;
    InSequence s;
    auto       key_l_move    = KeymapKey{0, 1, 0, TD(TD_L_MOVE)};
    auto       key_normal    = KeymapKey{0, 2, 0, CUST_XY};
