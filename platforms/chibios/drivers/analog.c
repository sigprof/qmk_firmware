...
__attribute__((weak)) adc_mux pinToMux(pin_t pin) {
    switch (pin) {
        ...
        case PAL_LINE(GPIOA, 0):  return TO_MUX( ADC_CHSELR_CHSEL0,  0 );
        case PAL_LINE(GPIOA, 1):  return TO_MUX( ADC_CHSELR_CHSEL1,  0 );
        case PAL_LINE(GPIOA, 2):  return TO_MUX( ADC_CHSELR_CHSEL2,  0 );
        case PAL_LINE(GPIOA, 3):  return TO_MUX( ADC_CHSELR_CHSEL3,  0 );
        case PAL_LINE(GPIOA, 4):  return TO_MUX( ADC_CHSELR_CHSEL4,  0 );
        case PAL_LINE(GPIOA, 5):  return TO_MUX( ADC_CHSELR_CHSEL5,  0 );
        case PAL_LINE(GPIOA, 6):  return TO_MUX( ADC_CHSELR_CHSEL6,  0 );
        case PAL_LINE(GPIOA, 7):  return TO_MUX( ADC_CHSELR_CHSEL7,  0 );
        case PAL_LINE(GPIOB, 0):  return TO_MUX( ADC_CHSELR_CHSEL8,  0 );
        case PAL_LINE(GPIOB, 1):  return TO_MUX( ADC_CHSELR_CHSEL9,  0 );
        case PAL_LINE(GPIOC, 0):  return TO_MUX( ADC_CHSELR_CHSEL10, 0 );
        case PAL_LINE(GPIOC, 1):  return TO_MUX( ADC_CHSELR_CHSEL11, 0 );
        case PAL_LINE(GPIOC, 2):  return TO_MUX( ADC_CHSELR_CHSEL12, 0 );
        case PAL_LINE(GPIOC, 3):  return TO_MUX( ADC_CHSELR_CHSEL13, 0 );
        case PAL_LINE(GPIOC, 4):  return TO_MUX( ADC_CHSELR_CHSEL14, 0 );
        case PAL_LINE(GPIOC, 5):  return TO_MUX( ADC_CHSELR_CHSEL15, 0 );
#elif defined(STM32F3XX)
